...
Curabitur porta auctor quam, pretium facilisis nisl. Pellentesque efficitur elit ante, vel vulputate tortor blandit nec.
  ...
  <div className="w-full lg:w-1/2 mt-4 lg:mt-0 px-2">
   ...
   <p className="text-gray-600 text-sm sm:text-base leading-snug sm:leading-relaxed mb-2 sm:mb-4 max-w-prose px-3 sm:px-6 
...
>
  <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
    ...
    commodo iaculis. Donec augue diam, tristique et ultricies nec, consectetur quis
    enim. Nullam id rutrum ex. Aliquam a lectus id lacus rhoncus dapibus non ac
    justo. Vivamus lacinia vestibulum metus in dapibus. Vestibulum sit amet
    sollicitudin enim. Ut id interdum turpis. Curabitur porta auctor quam, pretium
    facilisis nisl. Pellentesque efficitur elit ante, vel vulputate tortor blandit nec.
  </p>
</div>

        {/* Website Info */}
        <div className="mt-[360px] md:mt-[280px] lg:mt-[150px]  sm:mt-16 lg:mt-20 px-2 sm:px-4">
