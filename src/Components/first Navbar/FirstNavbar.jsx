        ...
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1 ">
          ...
          <div className="hidden md:block">
            <ul className="flex space-x-6 text-sm font-normal">
              ...
              <li className="border-r-1 border-gray-300 pe-4">
                Need help? Call Us:
              ...
              <li className="relative">
                <button className="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded-sm cursor-pointer md:border-0  md:p-0 md:w-auto dark:text-white">
                  USD
                  <svg
                    className="w-2.5 h-2.5 ms-2.5"
                    aria-hidden="true"
