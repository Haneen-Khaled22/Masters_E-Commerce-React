...
function Home() {
  ...
  <div className="relative w-3/4 h-[400px] mt-4 mb-6">
    ...
    <div className="absolute inset-0 flex flex-col justify-center items-center rounded-lg">
            <h2 className="text-base sm:text-lg md:text-xl">only-from <h2 className="text-base sm:text-lg md:text-xl text-[#D51243] font-bold">$7.99</h2></h2>
  ...
  />
      ...
      <p className='text-gray-400 text-sm mb-3'>Don't miss this opportunity at a special discount just for this week..</p>
  ...
  <p className="text-center">
    Super discount for your <span className="font-semibold underline ml-1">first purchase.</span>
  </p>
