  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
      {banners.map((banner) => (
        <div
          key={banner.id}
          className="relative rounded-lg overflow-hidden h-44 md:h-48 lg:h-52 flex items-center"
          style={{
        ...
        >
          <div className="relative z-10 p-6 bg-transparent space-y-2">
            ...
            <Link to="/shop">
              <button className="mt-3 w-[100px] h-[34px] rounded-full bg-[#C2C2D3] border border-[#C2C2D3] text-white text-[12px] font-medium font-[Inter] hover:bg-[#b3b3c9] transition cursor-pointer">
                Shop Now
              </button>
            </Link>
          </div>
